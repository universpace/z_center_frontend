...
{#if !isDisable()}
    {#if !fold}
        <aside class="w-[256px] h-full bg-white px-[24px] pt-[17px] pb-[22px]"
            ...
            <p class="text-lg font-semibold text-left text-accentBlue" on:click="{()=>{push('/')}}">ZwonCenterManager</p>
            <section class="mt-[42px] flex " id="teacherInfo">
                <div class="w-[46px] h-[46px] rounded-[23px] bg-gray p-[13px] mr-[16px]">
                    <img src="src/assets/images/icons/contacts.svg" class="w-[20px] h-[20px]"/>
                </div>
                <p>
        <span class="w-full text-sm font-medium text-left text-black">
            ...
            <section class="mt-[40px]">
                <div class="flex" on:click="{()=>{push('/')}}">
                    <img src="src/assets/images/icons/dashboard.svg" alt="dashboard" class={`w-[20px] h-[20px] ${current === '/' ? 'color-accentBlue' : 'color-gray'}`}/>
                    <p class={`ml-[14px] font-medium text-left ${current === '/' ? 'text-accentBlue' : 'text-gray'}`}>Dashboard</p>
                </div>
                <div class="flex mt-[20px]" on:click="{()=>{push('/student/list')}}">
                    <img src="src/assets/images/icons/contacts.svg" alt="students" class="w-[20px] h-[20px]"/>
                    <p class="ml-[14px] font-medium text-left text-gray">Students</p>
                </div>
                <div class="flex mt-[20px]" on:click="{()=>{push('/record/list')}}">
                    <img src="src/assets/images/icons/deals.svg" alt="records" class="w-[20px] h-[20px]"/>
                    <p class="ml-[14px] font-medium text-left text-gray">Records</p>
                </div>
                <div class="flex mt-[20px]" on:click="{()=>{push('/settings')}}">
                    <img src="src/assets/images/icons/settings.svg" alt="settings" class="w-[20px] h-[20px]"/>
                    <p class="ml-[14px] font-medium text-left text-gray">Settings</p>
                </div>
            </section>
            <section class="mt-[351px] flex" on:click="{()=>{fold = !fold}}">
                <img src="src/assets/images/icons/toggle.svg" alt="toggle" class="w-[14px] h-[14px]"/>
    ...
    {:else}
        <aside class="w-[68px] h-full bg-white px-[11px] pt-[17px] pb-[22px]"
            ...
            <section class="mt-[40px] ml-[13px]">
                <div class="flex" on:click="{()=>{push('/')}}">
                    <img src="src/assets/images/icons/dashboard.svg" alt="dashboard" class={`w-[20px] h-[20px] ${current === '/' ? 'color-accentBlue' : 'color-gray'}`}/>
                    <p class={`ml-[14px] font-medium text-left ${current === '/' ? 'text-accentBlue' : 'text-gray'}`}>&nbsp;</p>
                </div>
                <div class="flex mt-[20px]" on:click="{()=>{push('/student/list')}}">
                    <img src="src/assets/images/icons/contacts.svg" alt="students" class="w-[20px] h-[20px]"/>
                    <p class={`ml-[14px] font-medium text-left ${current === '/' ? 'text-accentBlue' : 'text-gray'}`}>&nbsp;</p>
